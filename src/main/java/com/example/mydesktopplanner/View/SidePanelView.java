        ...
        public TacheListView( Tache tache) throws IOException {
            ...
            view.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    try {
                        MainView.getInstance().setRightSidePannel((new RightSidePannelTache(tache)).getView());
                    } catch (IOException e) {
    ...
    private class PeriodeListView {
        ...
        public PeriodeListView(Periode periode) throws IOException {
            ...
            view.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    try {
                        MainView.getInstance().setRightSidePannel((new RightSidePannelPeriode(periode)).getView());
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                }
