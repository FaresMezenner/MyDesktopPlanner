        ...
        ((Button) view.lookup("#projet")).setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    stage.setScene(new Scene(FXMLLoader.load(Main.class.getResource("AjouterProjet.fxml"))));
                    stage.show();
...
//                }
        ...
        ((Button) view.lookup("#periode")).setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                try {
                    Stage stage = new Stage();
                    stage.setScene(new Scene(FXMLLoader.load(Main.class.getResource("AjouterPeriode.fxml"))));
                    stage.show();
...
//                }
        ...
        ((Button) view.lookup("#creneau")).setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Stage ajouterCreneau = new Stage();
                try {
                    ajouterCreneau.setScene(new Scene(FXMLLoader.load(Main.class.getResource("AjouterCreneau.fxml"))));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
                ajouterCreneau.show();
